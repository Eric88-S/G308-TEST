...
static const _StudentInfo_type_support_symbol_names_t _StudentInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, status_interfaces, msg, StudentInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, status_interfaces, msg, StudentInfo)),
  }
};
...
{
  return &::status_interfaces::msg::rosidl_typesupport_cpp::StudentInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, status_interfaces, msg, StudentInfo)() {
  return get_message_type_support_handle<status_interfaces::msg::StudentInfo>();
}
