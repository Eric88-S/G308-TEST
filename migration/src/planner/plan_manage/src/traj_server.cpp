...
void cmdCallback()
{
  ...
  static rclcpp::Time time_last = rclcpp::Clock(RCL_ROS_TIME).now();
...
int main(int argc, char **argv)
{
  ...
  auto bspline_sub = node->create_subscription<ego_planner::msg::Bspline>("planning/bspline", 10, bsplineCallback);
  ...
  time_forward_ = node->declare_parameter<double>("traj_server/time_forward", -1.0);
  last_yaw_ = 0.0;
  last_yaw_dot_ = 0.0;
