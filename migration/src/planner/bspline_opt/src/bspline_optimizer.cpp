...
namespace ego_planner
{
  ...
  {
    lambda1_ = nh->declare_parameter<double>("optimization/lambda_smooth", -1.0);
    lambda2_ = nh->declare_parameter<double>("optimization/lambda_collision", -1.0);
    lambda3_ = nh->declare_parameter<double>("optimization/lambda_feasibility", -1.0);
    lambda4_ = nh->declare_parameter<double>("optimization/lambda_fitness", -1.0);
    ...
    order_ = nh->declare_parameter<int>("optimization/order", 3);
  }
  ...
  bool BsplineOptimizer::rebound_optimize()
  {
    ...
    rclcpp::Time t0 = rclcpp::Clock(RCL_ROS_TIME).now();
    rclcpp::Time t1, t2;
    ...
    do
    {
      ...
      t2 = rclcpp::Clock(RCL_ROS_TIME).now();
