...
main(int argc, char** argv)
{
  ...
  update_freq = nh->declare_parameter<double>("update_freq", 1.0);
  scale = nh->declare_parameter<double>("resolution", 0.38);
  sizeX = nh->declare_parameter<int>("x_length", 100);
  sizeY = nh->declare_parameter<int>("y_length", 100);
  sizeZ = nh->declare_parameter<int>("z_length", 10);

  type = nh->declare_parameter<int>("type", 1);
