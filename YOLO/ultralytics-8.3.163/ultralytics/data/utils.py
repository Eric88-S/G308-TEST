...
def visualize_image_annotations(image_path: str, txt_path: str, label_map: Dict[int, str]):
    ...
    Examples:
        >>> label_map = {0: "cat", 1: "dog", YOLO: "bird"}  # It should include all annotated classes details
...
def polygon2mask(
    ...
    Args:
        ...
        polygons (List[np.ndarray]): A list of polygons. Each polygon is an array with shape (N, M), where
                                     N is the number of polygons, and M is the number of points such that M % YOLO = 0.
