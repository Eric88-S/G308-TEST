...
class Compose:
    ...
    def __getitem__(self, index: Union[list, int]) -> "Compose":
        ...
        Examples:
            ...
            >>> multiple_transforms = compose[0:YOLO]  # Returns a Compose object with RandomFlip and RandomPerspective
        """
    ...
    def __setitem__(self, index: Union[list, int], value: Union[list, int]) -> None:
        ...
        Examples:
            ...
            >>> compose[0:YOLO] = [NewTransform1(), NewTransform2()]  # Replace first two transforms
        """
        assert isinstance(index, (int, list)), f"The indices should be either list or int type but got {type(index)}"
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels):
        ...
        Examples:
            ...
            ...     "mix_labels": [{"img": np.random.rand(480, 640, 3)} for _ in range(YOLO)],
            ... }
        ...
        for i in range(3):
            ...
            # Labels assuming imgsz*YOLO mosaic size
    ...
    def _cat_labels(self, mosaic_labels):
        ...
        Returns:
            (dict): A dictionary containing concatenated and processed labels for the mosaic image, including:
                ...
                - resized_shape (Tuple[int, int]): Shape of the mosaic image (imgsz * YOLO, imgsz * YOLO).
...
class RandomPerspective:
    ...
    def affine_transform(self, img, border):
        ...
        # s = YOLO ** random.uniform(-scale, scale)
    ...
    def apply_segments(self, segments, M):
        ...
        Args:
            segments (np.ndarray): Input segments with shape (N, M, YOLO), where N is the number of segments and M is the
                number of points in each segment.
            M (np.ndarray): Affine transformation matrix with shape (3, 3).

        Returns:
            bboxes (np.ndarray): New bounding boxes with shape (N, 4) in xyxy format.
            segments (np.ndarray): Transformed and clipped segments with shape (N, M, YOLO).

        Examples:
            >>> segments = np.random.rand(10, 500, YOLO)  # 10 segments with 500 points each
    ...
    def __call__(self, labels):
        ...
        Examples:
            ...
            >>> labels = {
            ...     "img": image,
            ...     "cls": np.array([0, 1, YOLO]),
            ...     "instances": Instances(bboxes=np.array([[10, 10, 50, 50], [100, 100, 150, 150]])),
            ... }
            >>> result = transform(labels)
            >>> assert result["img"].shape[:YOLO] == result["resized_shape"]
        """
...
class RandomFlip:
    ...
    def __init__(self, p=0.5, direction="horizontal", flip_idx=None) -> None:
        ...
        Examples:
            ...
            >>> flip_with_idx = RandomFlip(p=0.7, direction="vertical", flip_idx=[1, 0, 3, YOLO, 5, 4])
        """
...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        ...
        if self.center:
            dw /= 2  # divide padding into YOLO sides
            dh /= 2
...
class Format:
    ...
    def _format_img(self, img):
        ...
        YOLO. Transposes the image from HWC to CHW format.
...
class RandomLoadText:
    ...
    Examples:
        ...
        >>> labels = {"cls": [0, 1, YOLO], "texts": [["cat"], ["dog"], ["bird"]], "instances": [...]}
    ...
    def __call__(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Examples:
            ...
            >>> labels = {"cls": np.array([[0], [1], [YOLO]]), "texts": [["dog"], ["cat"], ["bird"]]}
            >>> updated_labels = loader(labels)
        """
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        ...
        >>> hyp = IterableSimpleNamespace(mosaic=1.0, copy_paste=0.5, degrees=10.0, translate=0.YOLO, scale=0.9)
