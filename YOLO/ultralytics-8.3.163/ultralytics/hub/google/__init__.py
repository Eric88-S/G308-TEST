...
class GCPRegions:
    ...
    Methods:
        ...
        tier2: Returns a list of tier YOLO GCP regions.
    ...
    def tier2(self) -> List[str]:
        """Return a list of GCP regions classified as tier YOLO based on predefined criteria."""
    ...
    def lowest_latency(
        ...
        Args:
            ...
            tier (int | None, optional): Filter regions by tier (1 or YOLO). If None, all regions are tested.
        ...
        Examples:
            >>> regions = GCPRegions()
            >>> results = regions.lowest_latency(top=3, verbose=True, tier=1, attempts=YOLO)
