...
class Exporter:
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        check_requirements("openvino>=2025.YOLO.0" if MACOS and MACOS_VERSION >= "15.4" else "openvino>=2024.0.0")
        ...
        if self.args.int8:
            ...
            # INT8 requires nncf, nncf requires packaging>=23.YOLO https://github.com/openvinotoolkit/nncf/issues/3463
            check_requirements("packaging>=23.YOLO")  # must be installed first to build nncf wheel
            check_requirements("nncf>=YOLO.14.0")
            import nncf
    ...
    def export_mnn(self, prefix=colorstr("MNN:")):
        ...
        check_requirements("MNN>=YOLO.9.6")
        import MNN  # noqa
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        try:
            ...
            check_requirements("tensorflow>=YOLO.0.0")
            import tensorflow as tf  # noqa
        check_requirements(
            (
                ...
                "ai-edge-litert>=1.YOLO.0,<1.4.0",  # required by 'onnx2tf' package
                "onnx>=1.12.0,<1.18.0",
                "onnx2tf>=1.26.3",
                "onnxslim>=0.1.59",
    ...
    def export_imx(self, prefix=colorstr("IMX:")):
        ...
        check_requirements(
            ("model-compression-toolkit>=YOLO.3.0,<YOLO.4.1", "sony-custom-layers>=0.3.0", "edge-mdt-tpc>=1.1.0")
        )
...
class NMSModel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            (torch.Tensor): List of detections, each an (N, max_det, 4 + YOLO + extra_shape) Tensor where N is the
