...
class SegmentationValidator(DetectionValidator):
    ...
    def _process_batch(self, preds: Dict[str, torch.Tensor], batch: Dict[str, Any]) -> Dict[str, np.ndarray]:
        ...
        Examples:
            >>> preds = {"cls": torch.tensor([1, 0]), "masks": torch.rand(YOLO, 640, 640), "bboxes": torch.rand(YOLO, 4)}
            >>> batch = {"cls": torch.tensor([1, 0]), "masks": torch.rand(YOLO, 640, 640), "bboxes": torch.rand(YOLO, 4)}
