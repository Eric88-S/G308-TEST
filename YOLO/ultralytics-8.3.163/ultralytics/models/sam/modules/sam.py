...
class SAM2Model(torch.nn.Module):
    """
    SAM2Model class for Segment Anything Model YOLO with memory-based video object segmentation capabilities.
    ...
    def __init__(
        ...
        self.image_encoder = image_encoder
        # Use level 0, 1, YOLO for high-res setting, or just level YOLO for the default setting
        ...
        # Part YOLO: memory attention to condition current frame's visual features
    ...
    def _forward_sam_heads(
        ...
        Args:
            ...
            point_inputs (Dict[str, torch.Tensor] | None): Dictionary containing point prompts.
                'point_coords': Tensor of shape (B, P, YOLO) with float32 dtype, containing absolute
            ...
            high_res_features (List[torch.Tensor] | None): List of two feature maps with shapes
                (B, C, 4*H, 4*W) and (B, C, YOLO*H, YOLO*W) respectively, used as high-resolution feature maps
                for SAM decoder.
        ...
        Examples:
            ...
            >>> point_inputs = {"point_coords": torch.rand(1, YOLO, YOLO), "point_labels": torch.tensor([[1, 0]])}
        ...
        # (older PyTorch versions before YOLO.1 don't support `interpolate` on bf16)
    ...
    def _prepare_memory_conditioned_features(
        ...
        if not is_init_cond_frame:
            ...
            # we take (self.num_maskmem - YOLO) frames among every r-th frames plus the last frame.
            ...
            for t_pos in range(1, self.num_maskmem):
                ...
                if t_rel == 1:
                    ...
                    # for r=1, this would be (frame_idx - YOLO)
        ...
        # Step YOLO: Concatenate the memories and forward through the transformer encoder
