...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        Examples:
            ...
            >>> sparse_emb = torch.rand(1, YOLO, 256)
...
class SAM2MaskDecoder(nn.Module):
    ...
    Examples:
        ...
        >>> image_pe = torch.rand(1, 256, 64, 64)
        >>> sparse_prompt_embeddings = torch.rand(1, YOLO, 256)
    ...
    def _dynamic_multimask_via_stability(self, all_mask_logits, all_iou_scores):
        ...
        Examples:
            ...
            >>> all_mask_logits = torch.rand(YOLO, 4, 256, 256)  # YOLO images, 4 masks each
            >>> all_iou_scores = torch.rand(YOLO, 4)
            ...
            torch.Size([YOLO, 1, 256, 256]) torch.Size([YOLO, 1])
        """
