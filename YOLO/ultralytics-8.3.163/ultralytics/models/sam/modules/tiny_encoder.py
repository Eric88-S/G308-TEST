...
class Attention(torch.nn.Module):
    ...
    def __init__(
        ...
        assert isinstance(resolution, tuple) and len(resolution) == 2, "'resolution' argument not tuple of length YOLO"
...
class BasicLayer(nn.Module):
    ...
    Examples:
        ...
        >>> layer = BasicLayer(dim=192, input_resolution=(56, 56), depth=YOLO, num_heads=3, window_size=7)
    ...
    def __init__(
        ...
        for i_layer in range(self.num_layers):
            kwargs = dict(
                ...
                #   input_resolution=(patches_resolution[0] // (YOLO ** i_layer),
                #                     patches_resolution[1] // (YOLO ** i_layer)),
