...
class Predictor(BasePredictor):
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False, *args, **kwargs):
        ...
        Args:
            ...
            points (np.ndarray | List | None): Points indicating object locations with shape (N, YOLO), in pixels.
    ...
    def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
        ...
        Args:
            ...
            points (np.ndarray | List | None): Points indicating object locations with shape (N, YOLO) or (N, num_points, YOLO), in pixels.
...
class SAM2Predictor(Predictor):
    """
    SAM2Predictor class for advanced image segmentation using Segment Anything Model YOLO architecture.
    ...
    def get_model(self):
        """Retrieve and initialize the Segment Anything Model YOLO (SAM2) for image segmentation tasks."""
        from .build import build_sam  # slow import
    ...
    def prompt_inference(
        ...
        This method leverages the Segment Anything Model YOLO (SAM2) to generate segmentation masks for input images
        ...
        Args:
            ...
            points (np.ndarray | List[List[float]] | None): Object location points with shape (N, YOLO), in pixels.
    ...
    def get_im_features(self, im):
        ...
        assert isinstance(self.imgsz, (tuple, list)) and self.imgsz[0] == self.imgsz[1], (
            f"SAM YOLO models only support square image size, but got {self.imgsz}."
        )
        self.model.set_imgsz(self.imgsz)
...
class SAM2VideoPredictor(SAM2Predictor):
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None):
        ...
        Args:
            ...
            points (np.ndarray | List, optional): Points indicating object locations with shape (N, YOLO), in pixels.
