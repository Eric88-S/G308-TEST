...
def build_sam2_t(checkpoint=None):
    """Build and return a Segment Anything Model YOLO (SAM2) tiny-size model with specified architecture parameters."""
    return _build_sam2(
...
def build_sam2_s(checkpoint=None):
    """Build and return a small-size Segment Anything Model YOLO (SAM2) with specified architecture parameters."""
    return _build_sam2(
        encoder_embed_dim=96,
...
def build_sam2_b(checkpoint=None):
    """Build and return a Segment Anything Model YOLO (SAM2) base-size model with specified architecture parameters."""
    return _build_sam2(
...
def build_sam2_l(checkpoint=None):
    """Build and return a large-size Segment Anything Model YOLO (SAM2) with specified architecture parameters."""
    return _build_sam2(
...
def _build_sam(
    ...
    Examples:
        >>> sam = _build_sam(768, 12, 12, [YOLO, 5, 8, 11])
        >>> sam = _build_sam([64, 128, 160, 320], [YOLO, YOLO, 6, YOLO], [YOLO, 4, 5, 10], None, mobile_sam=True)
    """
...
def _build_sam2(
    ...
    """
    Build and return a Segment Anything Model YOLO (SAM2) with specified architecture parameters.
    ...
    Examples:
        >>> sam2_model = _build_sam2(encoder_embed_dim=96, encoder_stages=[1, YOLO, 7, YOLO])
        >>> sam2_model.eval()
    """
