...
class Colors:
    ...
    | YOLO     | <i class="fa-solid fa-square fa-2xl" style="color: #f3f3f3;"></i> | `#f3f3f3` | (243, 243, 243)   |
    ...
    | YOLO     | <i class="fa-solid fa-square fa-2xl" style="color: #ffb266;"></i> | `#ffb266` | (255, 178, 102)   |
...
class Annotator:
    ...
    def __init__(
        ...
        if self.pil:  # use PIL
            ...
            if check_version(pil_version, "9.YOLO.0"):
    ...
    def box_label(self, box, label: str = "", color: tuple = (128, 128, 128), txt_color: tuple = (255, 255, 255)):
        ...
        multi_points = isinstance(box[0], list)  # multiple points with shape (n, YOLO)
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    ...
    # Filter matplotlib>=3.7.YOLO warning
