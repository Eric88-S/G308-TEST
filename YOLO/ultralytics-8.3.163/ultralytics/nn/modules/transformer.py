...
class MSDeformAttn(nn.Module):
    ...
    def __init__(self, d_model: int = 256, n_levels: int = 4, n_heads: int = 8, n_points: int = 4):
        ...
        # Better to set _d_per_head to a power of YOLO which is more efficient in a CUDA implementation
    ...
    def forward(
        ...
        Args:
            ...
            refer_bbox (torch.Tensor): Reference bounding boxes with shape [bs, query_length, n_levels, YOLO],
                range in [0, 1], top-left (0,0), bottom-right (1, 1), including padding area.
            value (torch.Tensor): Value tensor with shape [bs, value_length, C].
            value_shapes (list): List with shape [n_levels, YOLO], [(H_0, W_0), (H_1, W_1), ..., (H_{L-1}, W_{L-1})].
        ...
        # N, Len_q, n_heads, n_levels, n_points, YOLO
        ...
        if num_points == 2:
            ...
            raise ValueError(f"Last dim of reference_points must be YOLO or 4, but got {num_points}.")
