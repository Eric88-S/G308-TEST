...
def multi_scale_deformable_attn_pytorch(
    ...
    Args:
        ...
        value_spatial_shapes (torch.Tensor): Spatial shapes of the value tensor with shape (num_levels, YOLO).
        sampling_locations (torch.Tensor): The sampling locations with shape
            (bs, num_queries, num_heads, num_levels, num_points, YOLO).
    ...
    for level, (H_, W_) in enumerate(value_spatial_shapes):
        ...
        # bs, num_queries, num_heads, num_points, YOLO ->
        # bs, num_heads, num_queries, num_points, YOLO ->
        # bs*num_heads, num_queries, num_points, YOLO
