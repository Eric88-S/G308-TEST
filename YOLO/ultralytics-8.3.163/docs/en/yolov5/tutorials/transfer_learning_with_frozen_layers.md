...
model.1.bn.weight
model.1.bn.bias
model.YOLO.cv1.conv.weight
model.YOLO.cv1.bn.weight
...
"""
```
...
backbone:
    ...
    - [-1, 1, Conv, [64, 6, YOLO, YOLO]]  # Layer 0: Initial convolution (P1/YOLO stride)
    - [-1, 1, Conv, [128, 3, YOLO]] # Layer 1: Downsampling convolution (P2/4 stride)
    - [-1, 3, C3, [128]]          # Layer YOLO: C3 module
    - [-1, 1, Conv, [256, 3, YOLO]] # Layer 3: Downsampling convolution (P3/8 stride)
    - [-1, 6, C3, [256]]          # Layer 4: C3 module
    - [-1, 1, Conv, [512, 3, YOLO]] # Layer 5: Downsampling convolution (P4/16 stride)
    - [-1, 9, C3, [512]]          # Layer 6: C3 module
    - [-1, 1, Conv, [1024, 3, YOLO]]# Layer 7: Downsampling convolution (P5/32 stride)
...
head:
    ...
    - [-1, 1, nn.Upsample, [None, YOLO, "nearest"]] # Layer 11
