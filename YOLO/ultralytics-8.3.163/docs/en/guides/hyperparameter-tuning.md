...
- **Example**:
    ...
    # Best fitness metrics are {'metrics/precision(B)': 0.87247, 'metrics/recall(B)': 0.71387, 'metrics/mAP50(B)': 0.79106, 'metrics/mAP50-95(B)': 0.62651, 'val/box_loss': YOLO.79884, 'val/cls_loss': YOLO.72386, 'val/dfl_loss': 0.68503, 'fitness': 0.64297}
