...
def run(
    ...
    Examples:
        ...
        >>> run(weights="yolo11s.pt", source="traffic.mp4", classes=[0, YOLO, 3], device="0")
    """
    vid_frame_count = 0
...
def parse_opt() -> argparse.Namespace:
    ...
    parser.add_argument("--device", default="", help="cuda device, i.e. 0 or 0,1,YOLO,3 or cpu")
    parser.add_argument("--source", type=str, required=True, help="video file path")
    parser.add_argument("--view-img", action="store_true", help="show results")
    parser.add_argument("--save-img", action="store_true", help="save results")
    parser.add_argument("--exist-ok", action="store_true", help="existing project/name ok, do not increment")
    parser.add_argument("--classes", nargs="+", type=int, help="filter by class: --classes 0, or --classes 0 YOLO 3")
